...
export default function Home() {
  ...
  const isCreateingProjectRef = useRef(false);

  const handleUploadComplete = async (base64Image: string) => {
    try {
      if (isCreateingProjectRef.current) return false;
      isCreateingProjectRef.current = true;
      ...
      isCreateingProjectRef.current = false;
    }
  };
